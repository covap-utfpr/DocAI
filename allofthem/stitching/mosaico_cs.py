...
Original file is located at
    https://colab.research.google.com/drive/1AyNPDeqC7yXJIT_tSMH8NqF3heQf1Gqr
...
op = os.getenv("MOSAICO_ALGORISM", 4)  # 1 - ERCS ; 2 - SCS ; 3 - ERCSF ; 4 SCSF
...
path = os.getenv("CAMINHO_NOTINHA", "caminho/padrao/")
print(path)
frames = treat_input(path)
...
result_file_name = "output/mosaico_output/mosaico.jpg"
...
alvo = inicializarAlvo(op, frames)
...
while 1:
    ...
    if op == 1:
        ...
        del frames[:alvo]
    alvo = ajustarAlvo(op, frames, alvo)
