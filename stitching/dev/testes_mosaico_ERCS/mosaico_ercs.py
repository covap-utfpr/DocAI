...
Original file is located at
    https://colab.research.google.com/drive/1TjY5XT1kAQEjkntoz2b09LEK4Fwxtqiy
...
frames = treat_input("/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/21")
...
result_file_name = "mosaico_21.jpg"
...
while 1:
    ...
    if matches == None:
        ...
        # print(len(frames))
        # print(alvo)
        if (len(frames) - 1) == alvo:  # Alvo == Pivo #Finalizando
            # print("Finalizando")
            break
        else:
    ...
    if (len(frames)) == alvo:  # Alvo == Pivo #Finalizando
        # print("Finalizando")
        break
