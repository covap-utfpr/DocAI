...
do
	...
	do
   	...
   	#Ajuste a pasta do data base
		sed -i "s|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/$((i-1))|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/$i|g" mosaico_ercs.py  	
		sed -i "s|result_file_name = \"mosaico_.*\.jpg\"|result_file_name = \"mosaico_$i.jpg\"|g" mosaico_ercs.py

		# Captura o tempo de início de cada execução
		inicio_item=$(date +%s)

		#execute o algoritimo
		saida_python=$(python3.9 mosaico_ercs.py)
