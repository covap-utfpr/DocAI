N=30 #Numero de NOTAS a testar
M=1 #Numero de VEZES a testar
...
# Captura o tempo de início total
	...
	do
	   ...
	   echo "===================================Execução número: $i================================================"
		...
		sed -i "s|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/$((i-1))|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/$i|g" mosaico_scs.py  	
		sed -i "s|result_file_name = \"mosaico_.*\.jpg\"|result_file_name = \"mosaico_$i.jpg\"|g" mosaico_scs.py

		# Captura o tempo de início de cada execução
		inicio_item=$(date +%s)

		#execute o algoritimo
	  	saida_python=$(python3.9 mosaico_scs.py)
	...
	sed -i "s|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/$i|/home/atosarruda/Documentos/IC - Erikson/DocAI/stitching/db/0|g" mosaico_scs.py 
done
