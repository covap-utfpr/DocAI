...
Original file is located at
    https://colab.research.google.com/drive/1kuUwnIIn5iYN382sjj0oN_vViey9c2Wr
...
matches, base_image_kp, sec_image_kp = find_matches(frames[idx_base], frames[idx_sec], threshold=0.7, debug_draw=True, min_matches=10)
...
for img2 in frames[1:]:
    mask_img2 = gaussian_mask(img2.shape)

    matches, base_image_kp, sec_image_kp = find_matches( img1, img2, 0.75, debug_draw=True)
    H = find_homography(base_image_kp, sec_image_kp, matches)
